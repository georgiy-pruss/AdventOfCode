NB. nice words http://adventofcode.com/day/5
...
main1 =: 3 : 0
  ...
  for_l. y do.
    l=. (13 32{a.) rstrip >l
    if. +./ l (contains >)"(_ 0) 'ab';'cd';'pq';'xy' do. continue. end.
    if. 3 > +/+/ 'aeiou' =/ l do. continue. end.
    if. +./ (}: = }.) l do. n=.>:n end.
  end.
  n
)
...
main2 =: 3 : 0
  ...
  for_l. y do.
    l=. (13 32{a.) rstrip >l
    if. -.+./=/ 2 _2}."0 _ l do. continue. end. NB. ...xyx...
    if. +./(2&{.(+./@:E.)2&}.)\. l do. n=.>:n end. NB. ...xy...xy...
  end.
  n
)
...
whether a string is naughty or nice. None of the old rules apply, as they are all clearly
ridiculous.
