...
For example, suppose you have the following Reindeer:
    ...
    Comet can fly 14 km/s for 10 seconds, but then must rest for
    127 seconds.
...
seconds into Comet's second burst: after the 140th second, Comet
pulls into the lead and gets his first point. Of course, since Dancer
had been in the lead for the 139 seconds before that, he has
